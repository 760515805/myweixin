...
import com.chenhj.bean.HttpClientResult;
...
public class HttpClientUtils {
	...
	public static  void setConf(Map<String, String> conf){
		Integer connect_timeout = 600000;
		try {
			 connect_timeout = Integer.valueOf(conf.get("connect_timeout"));
		} catch (Exception e) {
			connect_timeout = 600000;
		}
		Integer socket_timeout = 600000;
		try {
			socket_timeout = Integer.valueOf(conf.get("socket_timeout"));
		} catch (Exception e) {
